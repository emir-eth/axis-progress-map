  ...
  return (
    <footer className="mt-auto border-t border-border">
      <div className="content-shell flex flex-col items-center gap-3 px-5 py-8 text-center sm:px-8 sm:py-10">
        <p className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 font-mono text-[12px] tracking-[0.12em] text-ink sm:text-[13px]">
        ...
        <p className="max-w-md text-[12px] leading-relaxed text-text-muted sm:text-[13px]">
